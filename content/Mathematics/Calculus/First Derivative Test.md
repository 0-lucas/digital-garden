The *First [[Derivatives|Derivative]] Test* is a tool used in [[Differentiation]] for [[Differentiation Optimization|optimization]], when one wants to test if they found the **extreme value**.
___
# How does it work?
