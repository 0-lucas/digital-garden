...
*Integration testing* still test *units of work*, but it **does not have full control over it**, as it **uses real dependencies** such as production database, network, random number generation, and so on.
